...
let price = [
    56, 483, 40.80, 497, 540, 493, 510, 525, 489, 538,
    492, 510, 479, 485, 521, 508, 475, 495, 533, 487,
    540, 500, 517, 472, 509, 527, 523, 491, 509, 498,
    522, 490, 477, 514, 530, 485, 519, 478, 506, 528,
    509, 491, 516, 537, 485, 503, 492, 511, 499, 526
];
    ...
    return mealData.map(
        ...
        <div class="col-sm-6 col-xl-4 item">
            <div class="card">
            	...
            	<div class="card-body">
                    <h3 style="color: black;">${mealDetails.name}</h3>
    
                	<p style="color: black;">₹${price[a++]}</p>
